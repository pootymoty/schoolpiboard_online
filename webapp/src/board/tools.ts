...
/**
 * Палитра: два ряда по восемь.
 *
 * Первый ряд тёмный — им пишут и чертят; второй яркий — им выделяют и
 * подчёркивают поверх написанного. Прежний набор был собран из соседних
 * оттенков: два красных, два оранжевых, три синих, — и на доске они
 * различались только рядом друг с другом, а по отдельности выглядели
 * одинаково. Здесь каждый цвет отстоит от соседей по тону настолько,
 * чтобы его можно было назвать словом: «синим», «зелёным», «розовым».
 *
...
export const PALETTE = [
  '#1C1B1F', '#6B7280', '#C62828', '#EF6C00',
  '#2E7D32', '#00838F', '#1565C0', '#6A1B9A',
