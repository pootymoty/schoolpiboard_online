  ...
  return (
    <Page>
      <article className="card reading">
        <h1>О сервисе</h1>
        <p>
          SchoolPiBoard — замена тетради и маркерной доски на уроке: пишите
          пером, разбирайте задачи по учебнику, объясняйте, а ученик просто
          открывает ссылку и работает рядом.
        </p>
        <p>
          Поэтому ученику не нужна учётная запись, а ладонь на планшете не
          оставляет следа — иначе пером не пишут. Платит только преподаватель,
          и только за себя.
        </p>
        <p>
          ...
          — то же самое для занятий на расстоянии.
        </p>
      </article>
