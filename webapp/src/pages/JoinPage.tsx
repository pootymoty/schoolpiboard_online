 ...
 *
 * Войти можно без регистрации: участнику достаточно назвать имя.
 * Требовать от него учётную запись означало бы начинать каждую встречу
 * с технической возни.
 *
 * Дальше человек попадает в комнату ожидания, пока владелец доски не
 * решит, впускать ли его и с какой ролью. Роль назначается при приёме,
 * а не зашита в ссылку: одна ссылка на доску, и раздаётся она не глядя.
 */
export function JoinPage(): ReactElement {
  ...
  // Ждём решения владельца доски.
  if (result?.status === 'waiting') {
    return (
      <Page narrow>
        <div className="card waiting">
          <h1>Ждём владельца доски</h1>
          <p>
