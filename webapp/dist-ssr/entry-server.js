...
function Footer() {
  return /* @__PURE__ */ jsxs("footer", { className: "app__footer", children: [
    /* @__PURE__ */ jsxs("div", { className: "row", children: [
      /* @__PURE__ */ jsx(Link, { to: "/legal/terms", children: "Условия использования" }),
...
const DETAILS = HAS_COMPANY_DETAILS ? `Продавец: ${COMPANY.name}, ${COMPANY.status}, ИНН ${COMPANY.inn}. Связь: ${COMPANY.email}. Сайт: ${COMPANY.site}.` : "ЗАГЛУШКА: реквизиты продавца — ФИО, статус, ИНН и почта для связи.";
const DOCUMENTS = {
  terms: {
...
function LegalPage() {
  ...
  const document2 = DOCUMENTS[page ?? ""] ?? DOCUMENTS.terms;
  return /* @__PURE__ */ jsx(Page, { children: /* @__PURE__ */ jsxs("article", { className: "card reading", children: [
    /* @__PURE__ */ jsx("h1", { children: document2.title }),
    document2.paragraphs.map((paragraph, index) => /* @__PURE__ */ jsx("p", { children: paragraph }, index))
  ] }) });
}
