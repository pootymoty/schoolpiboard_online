...
const DOCUMENTS = {
  ...
  privacy: {
    ...
    paragraphs: [
      ...
      DETAILS,
      "ЗАГЛУШКА: сведения об операторе персональных данных и порядке обращения требуют согласования с юристом."
    ]
  },
  offer: {
    ...
    paragraphs: [
      ...
      DETAILS,
      "ЗАГЛУШКА: порядок разрешения споров и подсудность требуют согласования с юристом."
    ]
  }
};
function LegalPage() {
